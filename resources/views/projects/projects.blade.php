...
<body>
    ...
    <div class="form-group col-md-6">
      <h4>All the projects in the company</h4>
      <a class="btn btn-success" href="/projects/create">Create New Project</a>
    </div>
        ...
        <div class="col-sm-3">
          <div class="card">
              <div class="card-body">
                ...
                <a href="/projects/{{ $project->id }}" class="btn btn-primary">Go to the {{ $project->title }} Project</a>
              </div>
          </div><br>
        </div>
    @endforeach
